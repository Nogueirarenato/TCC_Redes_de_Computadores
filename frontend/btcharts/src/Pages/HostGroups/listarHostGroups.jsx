                ...
                <div className="containerModal" style={{ display: displayModal }}>
                    <div className="fundo-modal">
                        ...
                        <div className="botao-modal">
                            ...
                            <button className="margin1" onClick={this.convertTimestamp.bind(this, this.state.dataInicial, this.state.dataFinal)}><a href={`/Grafico?tipo=${this.state.tipoRelatorio}&DataInicial=${this.state.dataInicial}&DataFinal=${this.state.dataFinal}`}>Visualizar Gráficos</a></button>
                        </div>
                    </div>
                </div>
